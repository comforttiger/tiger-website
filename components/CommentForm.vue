<template>
  <div class="md:w-1/2 w-screen flex flex-col gap-4">
    ...
    <div v-if="!showCommentForm" class="flex gap-2 items-center w-fit">
        <FilledButton @click="toggleCommentForm"
          class="flex gap-2 items-center hover:cursor-pointer text-lg"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
