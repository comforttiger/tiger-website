  ...
  <div class="md:p-20">
    <div class="breadcrumbs text-accent bg-base-100 rounded-xl p-2 mb-2 w-fit">
      <ul>
        ...
        <li v-if="sub_category == 'guitar'"><NuxtLink to="/blog/diary/guitar">guitar</NuxtLink></li>
      </ul>
    </div>
    ...
    <div class="flex gap-2 bg-base-100 rounded-xl p-2 mt-2 w-fit" v-if="index && category == 'diary'">
