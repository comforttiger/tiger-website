<template>
  <div class="md:p-20">
    ...
    <NuxtLink to="/made/rss.xml" class="underline text-secondary bg-base-100 rounded-xl mt-2 p-2 flex gap-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
