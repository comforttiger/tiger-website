<template>
    <ul class="flex justify-center flex-wrap gap-1 bg-base-100 p-4 rounded-xl">
      ...
      <li><Button img="/buttons/renkon.gif" alt="renkon's website" link="https://renkotsuban.com/" /></li>
      <li><Button img="/buttons/pont.gif" alt="pont's website" link="https://pont.cool" /></li>
      <li><Button img="/buttons/colrana.gif" alt="colrana's website" link="https://colrana.neocities.org/" /></li>
      <li><Button img="/buttons/citadark.gif" alt="citadark" link="https://citadark.neocities.org/" /></li>
      <li><Button img="/buttons/maebubsy.gif" alt="mae bubsy website" link="https://mae.bubsy.org/" /></li>
      <li><Button img="/buttons/swiftyshq.gif" alt="swifty's hq" link="https://swiftyshq.neocities.org/" /></li>
      <li><Button img="/buttons/kokoscript.gif" alt="kokoscript" link="https://kokoscript.com/" /></li>
    </ul>
</template>
