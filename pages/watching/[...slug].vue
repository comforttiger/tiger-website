      ...
      <div class="min-h-screen flex flex-col gap-16">
        ...
        >
          <div :class="gridClass" class="grid-layout w-screen">
            ...
            <data class="p-category" v-for="tag in post.watch_tags" :value="tag"></data>
            <PostTitle
              v-if="!post.no_title"
              class="title"
              :timestamp="post.timestamp"
              :tags="post.watch_tags"
              :draft="post.watch_tags.includes('draft')"
              watching
            ...
            <div v-if="post.no_title" class="tags">
              ...
              <div class="flex gap-2 flex-wrap h-fit">
                ...
                <div v-for="tag in post.watch_tags" class="flex">
                  ...
                  <OutlineButton :to="{ path: '/watching', query: { tag: tag } }" v-else
                    >#{{ tag }}</OutlineButton
                  >
                </div>
